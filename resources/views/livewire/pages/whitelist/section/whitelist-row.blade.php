<tr wire:key="whitelist-row-{{ $record->getKey() }}"
    ...
    <td class="px-4 py-3.5 whitespace-nowrap w-px">
        <livewire:core.shared-components.item-actions :editUrl="route('gupa-panel.whitelist.edit', $record->id)"
            :deleteId="$record->id" :navigate="false" confirmMessage="{{ __('Yakin ingin menghapus whitelist ini?') }}"
